...
<img id="backgroundimage" src="../assets/city_location/bg.png" width=100% height=100%>
<div class="col-md-10 col-md-offset-2 col-sm-10 col-sm-offset-2 col-xs-12">
        <div class="col-md-12">
            <h1 class="text1">RAK</h1>
            <h1 class="text2">Locations</h1>
        </div>
        <div class="row">
            <div class="col-md-8 col-sm-8 col-xs-12">
               ...
               <div class="col-md-12 back-block">
                    <div class="col-md-3 col-sm-3 col-xs-12 pull-right">
                        <span>Back</span><img ng-src="../assets/city_location/back.png" />
                    </div>
                </div>
            </div>
        </div>
